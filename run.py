...
u_net = CnnUnet_GAN(x_channels=2, y_channels=2, layers_gen=3, feature_base_gen=8, feature_base_disc=64,)

trainer = Trainer(u_net, batch_size=30, validation_batch_size=50)
